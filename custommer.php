...
<body onload="time()">
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><i class="fa fa-user-circle" aria-hidden="true"></i> EMPLOYEE MANAGEMENT</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active"><a href="#home" data-toggle="tooltip" data-placement="bottom"
                        title="NHÂN VIÊN">EMPLOYEE</a></li>
                    <li><a href="" data-toggle="tooltip" data-placement="bottom"
                        title="ĐIỂM DANH">ATTENDANCE</a></li>
                    <li><a href=""  data-toggle="tooltip" data-placement="bottom"
                        title="TIỀN LƯƠNG">SALARY</a></li>
                    <li><a href=""  data-toggle="tooltip" data-placement="bottom"
                        title="LỊCH CÔNG TÁC">SCHEDULE</a></li>
                    <li><a href="#contact"  data-toggle="tooltip" data-placement="bottom"
                        title="BÁO CÁO">REPORT</a></li>
                    <li><a href="#tour"  data-toggle="tooltip" data-placement="bottom"
                        title="SỰ KIỆN">EVENT</a></li>
                    <li>
                        <a href="#"  data-toggle="tooltip" data-placement="bottom"
                        title="TÀI KHOẢN"><b>Account</b>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown">
                            <li><a href="/index.html"  data-toggle="tooltip" data-placement="bottom"
                                title="ĐĂNG XUẤT"><b> Logout <i class="fas fa-sign-out-alt"></i></b></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
    ...
    <div class="container-fluid al">
        ...
        <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Type the employee's name"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".add-new").click(function () {
                ...
                var row = '<tr>' +
                    '<td><input type="text" class="form-control" name="name" id="name" placeholder="Type name"></td>' +
                    '<td><input type="text" class="form-control" name="gioitinh" id="gioitinh" placeholder="Type gender"></td>' +
                    '<td><input type="text" class="form-control" name="namsinh" id="namsinh" value="" placeholder="Type date of birth"></td>' +
                    '<td><input type="text" class="form-control" name="diachi" id="diachi" value="" placeholder="Type address"></td>' +
                    '<td><input type="text" class="form-control" name="chucvu" id="chucvu" value="" placeholder="Type position"></td>' +
                    '<td>' + actions + '</td>' +
                    '</tr>';
                $("table").append(row);
